...
function campanha(id){
   ...
   app.preloader.show('blue');
    ...
    var url = "http://localhost/www2/php/campanha.php?id="+id+"";
    ...
    function ConectaServidor(response) {
        ...
        {   
            ...
            conteudo += "<button class='col button button-small button-round button-fill' onclick=''>Quero ajudar a campanha!</button></div>";
...
function tipocampanha(id){
    ...
    var xmlhttp = new XMLHttpRequest();
    var url = "http://localhost/www2/php/tipocampanha.php?id="+id+"";
...
function responsaveis(id){
    ...
    var xmlhttp = new XMLHttpRequest();
    var url = "http://localhost/www2/php/responsaveis.php?id="+id+"";
...
app.preloader.show('blue');
 var xmlhttp = new XMLHttpRequest();
    var url = "http://localhost/www2/php/selectcampanhas.php?ong="+ong+"";
...
function chamafot(ong) {
    app.router.navigate('/foto1/');
    
    app.preloader.show('blue');
    var xmlhttp = new XMLHttpRequest();
    var url = "http://localhost/www2/php/selectimgs.php?ong="+ong+"";
    ...
    var dados = JSON.parse(response); //faz a conversão do texto da WEB para JSON
       ...
       for (i = 0; i < dados.length; i++) //dados.length retorna o tamanho do vetor.
        {   
            ...
            conteudo += "<div class='card-content card-content-padding'><center><img src='imgs/"+ong+"/"+dados[i].tb12_seq+""+dados[i].tb12_extencao+"'></center></div>";
        ...
        document.getElementById('c4').innerHTML = conteudo;
...
function carregainfo(ong){
    ...
    app.preloader.show('blue');
    var xmlhttp = new XMLHttpRequest();
    var url = "http://localhost/www2/php/selectonginfo.php?ong="+ong+"";
    ...
    var dados = JSON.parse(response); //faz a conversão do texto da WEB para JSON
       ...
       for (i = 0; i < dados.length; i++) //dados.length retorna o tamanho do vetor.
        {   
            ...
            conteudo += "<img src='imgs/"+dados[i].tb01_cnpj+"/logo.png' style='margin-left: 35%'>";
            ...
            conteudo += "</div>";
            conteudo += "</li>";
            conteudo += "</ul><br><div class='row aa' style='margin-left: 5%; margin-right: 5%;'>";
            conteudo += "<button class='col button button-small button-round button-fill' onclick=''>Quero Doar!</button>";
            conteudo += "<button class='col button button-small button-round button-fill' onclick=''>Fotos</button>";
            conteudo += "</div> </div>";
...
function carreganecessidade2(ong) {
 ...
 var xmlhttp = new XMLHttpRequest();
    var url = "http://localhost/www2/php/selectnecessidades.php?ong="+ong+"";
...
function carregaurgencia2(ong) {
 ...
 var xmlhttp = new XMLHttpRequest();
    var url = "http://localhost/www2/php/selecturgencias.php?ong="+ong+"";
...
function carregaconturgencia(ong) {
 ...
 var xmlhttp = new XMLHttpRequest();
    var url = "http://localhost/www2/php/selecturgenciascont.php?ong="+ong+"";
...
$$(document).on('page:init', '.page[data-name="ongs"]', function (e) {
    ...
    app.preloader.show('blue');
    var xmlhttp = new XMLHttpRequest();
    var url = "http://localhost/www2/php/selectongs.php";
    ...
    function ConectaServidor(response) {
        ...
        for (i = 0; i < dados.length; i++) //dados.length retorna o tamanho do vetor.
        {
            ...
            conteudo += "<div style='padding-left: 9px;'> <img src='imgs/"+dados[i].tb01_cnpj+"/logo.png' style='height: 70px'></div>";
            conteudo += " </div>";
            conteudo += "<div class='col-33'>";
